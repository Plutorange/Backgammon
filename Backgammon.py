...
class Example(QMainWindow, Ui_Dialog):
    def __init__(self):
        super().__init__()
        self.fname = 'win_statistics.sqlite'
        self.wsum = 0
        self.bsum = 0
        self.sequence = 1
        self.bblot = 0
        ...
        self.dbchoiceButton.clicked.connect(self.show_dialog)
    ...
    def cor(self):
        ...
        if self.white_out == 15:
            ...
            self.sqlka = sqlite3.connect(self.fname)
...
VALUES(False,True)''')
    ...
    def show_dialog(self):
        self.fname = QFileDialog.getOpenFileName(self, 'Open file', '/home', 'Files (*.sqlite *.db)')
